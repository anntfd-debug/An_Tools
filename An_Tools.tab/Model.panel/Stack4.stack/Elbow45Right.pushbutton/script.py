...
def main():
    try:
        ref = uidoc.Selection.PickObject(
            ...
            PipeSelectionFilter(),
            "Chọn một điểm gần đầu ống để tạo co 45 độ sang phải"
        )
    ...
    # Xoay 45 độ sang phải quanh trục Z toàn cục.
    # Góc âm tương ứng chiều kim đồng hồ khi nhìn từ +Z xuống mặt phẳng XY.
    ...
    transaction = DB.Transaction(doc, "Tạo Elbow 45 độ sang phải")
